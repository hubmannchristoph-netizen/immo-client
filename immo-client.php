...
class ImmoClient {
    ...
    private function define_constants() {
        define('IMMO_CLIENT_VERSION', '1.3.0');
    ...
    public function enqueue_assets() {
        ...
        wp_enqueue_style('immo-client-card', IMMO_CLIENT_URL . 'assets/css/immo-list-card.css', array('immo-client-style'), IMMO_CLIENT_VERSION);
