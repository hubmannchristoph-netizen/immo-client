...
$render_unit_select = function () use ( $units ) {
	...
	<div class="immo-calc-unit-wrap">
		<label class="immo-calc-section-title" style="display:block; margin-bottom:0.4rem;">
			<?php esc_html_e( 'Wohneinheit', 'immo-client' ); ?>
		</label>
...
<?php if ( $enable_costs ) : ?>
	<div class="immo-accordion immo-accordion--calculator">
		<button class="immo-accordion-header" aria-expanded="false">
			<?php esc_html_e( '💰 Nebenkostenrechner', 'immo-client' ); ?>
			...
			<div class="immo-calculator"
				...
				<div class="immo-calculator-panel" data-panel="costs">
					<div class="immo-calc-section immo-calc-section--inputs">
						<h4 class="immo-calc-section-title"><?php esc_html_e( 'Eingabe', 'immo-client' ); ?></h4>
						<div class="immo-calc-input-row">
							<label class="immo-calc-price-label"><?php esc_html_e( 'Kaufpreis', 'immo-client' ); ?></label>
					...
					<div class="immo-calc-section immo-calc-section--results">
						<h4 class="immo-calc-section-title"><?php esc_html_e( 'Aufstellung', 'immo-client' ); ?></h4>
						<div class="immo-calc-items"></div>
						<div class="immo-calc-total">
							<span><?php esc_html_e( 'Nebenkosten gesamt', 'immo-client' ); ?></span>
							<span class="immo-calc-costs-total">0 €</span>
						</div>
						<div class="immo-calc-grand-total">
							<span><?php esc_html_e( 'Gesamtkosten (inkl. Kauf)', 'immo-client' ); ?></span>
				...
				<p class="immo-calc-disclaimer">
					<?php esc_html_e( 'Unverbindliche Schätzung – ersetzt keine Bank-/Steuerberatung.', 'immo-client' ); ?>
				</p>
			</div>
		</div>
	</div>
...
<?php if ( $enable_financing ) : ?>
	<div class="immo-accordion immo-accordion--calculator">
		<button class="immo-accordion-header" aria-expanded="false">
			<?php esc_html_e( '📊 Finanzierungsrechner', 'immo-client' ); ?>
			<span class="immo-accordion-icon" aria-hidden="true"></span>
		</button>
		<div class="immo-accordion-body" hidden>
			<div class="immo-calculator"
				...
				<div class="immo-calculator-panel" data-panel="financing">
					<div class="immo-calc-section immo-calc-section--inputs">
						...
						<div class="immo-calc-input-row">
							<label>
								<?php esc_html_e( 'Eigenkapital', 'immo-client' ); ?>
								<span class="immo-calc-equity-toggle" role="group" aria-label="<?php esc_attr_e( 'Einheit', 'immo-client' ); ?>">
									<button type="button" data-mode="eur"><?php esc_html_e( '€', 'immo-client' ); ?></button>
									<button type="button" data-mode="pct" class="active"><?php esc_html_e( '%', 'immo-client' ); ?></button>
								</span>
							</label>
							<div>
						...
						<div class="immo-calc-input-row">
							<label><?php esc_html_e( 'Zinssatz (% p.a.)', 'immo-client' ); ?></label>
							<input type="number" class="immo-calc-interest" min="0" max="20" step="0.1" value="<?php echo esc_attr( (string) $default_int ); ?>">
						</div>
						<div class="immo-calc-input-row">
							<label><?php esc_html_e( 'Laufzeit (Jahre)', 'immo-client' ); ?></label>
							<input type="number" class="immo-calc-term" min="1" max="50" step="1" value="<?php echo esc_attr( (string) $default_term ); ?>">
						</div>
						<div class="immo-calc-input-row">
							<label><?php esc_html_e( 'Sondertilgung (€/Jahr)', 'immo-client' ); ?></label>
							<input type="number" class="immo-calc-extra" min="0" step="1" value="<?php echo esc_attr( (string) $default_extra ); ?>">
						</div>
					</div>

					<div class="immo-calc-section immo-calc-section--results">
						<h4 class="immo-calc-section-title"><?php esc_html_e( 'Ergebnis', 'immo-client' ); ?></h4>

						<div class="immo-calc-row">
							<span class="immo-calc-row-label">
								<?php esc_html_e( 'Finanzierungsbedarf (Kauf + Nebenkosten)', 'immo-client' ); ?>
							</span>
							<span class="immo-calc-row-amount immo-calc-need">0 €</span>
						</div>
						<div class="immo-calc-row">
							<span class="immo-calc-row-label"><?php esc_html_e( 'Kreditsumme', 'immo-client' ); ?></span>
							<span class="immo-calc-row-amount immo-calc-loan">0 €</span>
						</div>

						<div class="immo-calc-results">
							<div class="immo-calc-row">
								<span class="immo-calc-row-label"><?php esc_html_e( 'Monatliche Rate', 'immo-client' ); ?></span>
								<span class="immo-calc-row-amount immo-calc-monthly">0 €</span>
							</div>
							<div class="immo-calc-row">
								<span class="immo-calc-row-label"><?php esc_html_e( 'Gesamt-Zinsen', 'immo-client' ); ?></span>
								<span class="immo-calc-row-amount immo-calc-total-interest">0 €</span>
							</div>
							<div class="immo-calc-row">
								<span class="immo-calc-row-label"><?php esc_html_e( 'Gesamtaufwand', 'immo-client' ); ?></span>
								<span class="immo-calc-row-amount immo-calc-total-payment">0 €</span>
							</div>
							<div class="immo-calc-row">
								<span class="immo-calc-row-label"><?php esc_html_e( 'Tilgung-Ende', 'immo-client' ); ?></span>
						...
						<?php if ( $show_table ) : ?>
							<button type="button" class="immo-amortization-toggle" aria-expanded="false">
								<?php esc_html_e( '▼ Tilgungsplan anzeigen', 'immo-client' ); ?>
							</button>
							<div class="immo-amortization-table-wrap" hidden>
								<table class="immo-amortization-table">
									<thead>
										<tr>
											<th><?php esc_html_e( 'Jahr', 'immo-client' ); ?></th>
											<th><?php esc_html_e( 'Zinsen', 'immo-client' ); ?></th>
											<th><?php esc_html_e( 'Tilgung', 'immo-client' ); ?></th>
											<th><?php esc_html_e( 'Restschuld', 'immo-client' ); ?></th>
										</tr>
									</thead>
