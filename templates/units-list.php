		...
		<li class="immo-units-listitem" data-status="<?php echo esc_attr( $u_status ); ?>">
			...
			<div class="immo-units-listitem-body">
				...
				<div class="immo-units-listitem-facts">
					...
					<?php if ( ! empty( $unit['floor'] ) || $unit['floor'] === '0' ) : ?><span>🏢 <?php echo esc_html( $unit['floor'] ); ?>. OG</span><?php endif; ?>
			...
			<div class="immo-units-listitem-price">
				...
				<?php endif; ?>
				<?php if ( $detail_url ) : ?>
					<a href="<?php echo esc_url( $detail_url ); ?>" class="immo-units-listitem-link">Details →</a>
				<?php endif; ?>
			</div>
		</li>
	<?php endforeach; ?>
